                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-hover table-bordered">
                                        ...
                                        <tbody>
                                            <?php $file = $this->db->get_where('file',['guru_id' => $this->session->userdata('id'),'jenis' => 1])->result();
                                                ...
                                                <td>
                                                    ...
                                                    <?php else : ?>
                                                        ...
                                                        <?php else : 
                                                            ...
                                                            <a href="<?= base_url('guru/pensiun/hapusfile/'.$f->id); ?>" class="badge badge-danger">Hapus</a>
                                    ...
                                    <a href="<?= base_url('guru/pensiun/cekberkas') ?>" class="mt-3 btn btn-primary">Selanjutnya</a>

                                    <a href="<?= base_url('guru/pensiun/detailpengajuan') ?>" class="mt-3 btn btn-secondary">Sebelumnya</a>
