                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="forms-sample" action="" method="post">
                                        ...
                                        <button type="submit" name="simpan" class="mt-3 btn btn-primary">Ajukan Pengajuan Pensiun</button>

                                        <a href="<?= base_url('guru/pengajuan') ?>" class="mt-3 btn btn-secondary">Cek data kembali</a>
