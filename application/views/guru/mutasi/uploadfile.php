                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-hover table-bordered">
                                        ...
                                        <tbody>
                                            <?php $file = $this->db->get_where('file',['guru_id' => $this->session->userdata('id'),'jenis' => 2])->result();
                                    ...
                                    <a href="<?= base_url('guru/mutasi/cekberkas') ?>" class="mt-3 btn btn-primary">Selanjutnya</a>

                                    <a href="<?= base_url('guru/mutasi/detailpengajuan') ?>" class="mt-3 btn btn-secondary">Sebelumnya</a>
