                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="" class="btn btn-primary btn-sm btn-rounded" data-toggle="modal" data-target="#tambahkeluarga" >Tambah Data Keluarga</a>
                                    <br><br>
                                            ...
                                            <tbody>
                                                <?php $i=1; foreach($keluarga as $k) : ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $k->status ?></td>
                                                        <td>
                                                            <a href="<?= base_url('guru/mutasi/hapusdatakeluarga/'.$k->id) ?>" onclick="return confirm('Hapus?');" class="badge badge-danger float-right tombol-hapus mb-1">Hapus</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                                <?php if(!$keluarga) : ?>
                                    ...
                                    <a href="<?= base_url('guru/mutasi/detailpengajuan') ?>" class="mt-3 btn btn-primary">Selanjutnya</a>

                                    <a href="<?= base_url('guru/mutasi') ?>" class="mt-3 btn btn-secondary">Sebelumnya</a>
