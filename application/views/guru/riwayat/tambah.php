        ...
        <div class="content-wrapper">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <h1 class="h3 text-gray-800 mb-4">Tambah Data Riwayat Pekerjaan</h1>
                                        ...
                                        <div class="card-body">
                                            <form method="post" action="">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="uraian" placeholder="Uraian" name="uraian" autocomplete="off" value="<?= set_value('uraian'); ?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="gaji_pokok" placeholder="Gaji Pokok" name="gaji_pokok" autocomplete="off" value="<?= set_value('gaji_pokok'); ?>">
                                                    <?= form_error('gaji_pokok','<small class="text-danger">','</small>'); ?>
                                                </div>
                                                <div class="form-group">
                                                    <label for="pejabat">SK Pejabat</label>
                                                    <input type="text" class="form-control" id="pejabat" placeholder="pejabat" name="pejabat" autocomplete="off" value="<?= set_value('pejabat'); ?>">
                                                    <?= form_error('pejabat','<small class="text-danger">','</small>'); ?>
                                                </div>
                                                <div class="form-group">
                                                    <label for="nomor">SK Nomor</label>
                                                    <input type="text" class="form-control" id="nomor" placeholder="SK Nomor" name="nomor" autocomplete="off" value="<?= set_value('nomor'); ?>">
