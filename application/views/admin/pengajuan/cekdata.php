                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <hr>
                            <h3>Nama Pegawai: <?= $pengajuan->nama ?>, Pensiun pada tanggal: <?= $pengajuan->pensiun ?></h3>
                                ...
                                <div class="col-md-8">
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <?php $file = $this->db->get_where('file',['guru_id' => $pengajuan->guru_id])->result();
                                            // var_dump($file);die;
                                            ?>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php else : ?>
                                                                <a href="<?= base_url('admin/pengajuan/validasi/1/'.$f->id) ?>" class="badge badge-success">Valid</a>
                                                                
                                                                <a href="<?= base_url('admin/pengajuan/validasi/2/'.$f->id) ?>" class='badge badge-danger'>Tidak Valid</a>
