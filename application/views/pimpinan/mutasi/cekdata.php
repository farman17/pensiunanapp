                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php else : ?>
                                                                <a href="<?= base_url('pimpinan/mutasi/validasi/1/'.$f->id) ?>" class="badge badge-success">Valid</a>
                                                                
                                                                <a href="<?= base_url('pimpinan/mutasi/validasi/2/'.$f->id) ?>" class='badge badge-danger'>Tidak Valid</a>
